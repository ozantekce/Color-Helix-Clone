...
public class Level : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        alwaysColoredImages[1] = base.transform.GetChild(0).GetComponent<Image>();
        alwaysColoredImages[2] = base.transform.GetChild(0).GetComponent<Image>();
    ...
    void Update()
    {
        ...
        {
            SetProgression(Ball.Z/ GameController.Instance.GetFinishLineDistance());
        }
        else if(progression.fillAmount >= 1 && Ball.Z == 0)
        {
            SetProgression(0);
        }
